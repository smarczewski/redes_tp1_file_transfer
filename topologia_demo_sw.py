...
makeTerm(h1, title="Host h1 - Servidor",
         cmd="python3 start-server.py -v -H10.0.0.1 -p12000 -s./server_files")

time.sleep(1)

makeTerm(h2, title="Host h2 - Cliente Subida",
         cmd="python3 upload.py -v -H10.0.0.1 -p12000 -s./client_files -nfile_3.jpg;read")
makeTerm(h3, title="Host h3 - Cliente Descarga",
         cmd="python3 download.py -v -H10.0.0.1 -p12000 -d./client_files -nfile_1.jpg;read")
makeTerm(h4, title="Host h4 - Cliente Descarga",
         cmd="python3 download.py -v -H10.0.0.1 -p12000 -d./client_files -nfile_2.jpg;read")
